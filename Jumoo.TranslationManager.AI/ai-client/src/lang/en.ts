export default {
  ai: {
    ...
    openAiModelDescription: "OpenAI model to use ofr translation.",
    githubModel: "Github AI Model",
    githubModelDescription: "Github AI model to use ofr translation.",
    azureModel: "Azure AI Model",
    azureModelDescription: "Azure AI model to use ofr translation.",
